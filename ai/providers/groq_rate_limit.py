# ai/providers/groq_rate_limit.py
import time
import logging
from threading import Lock

logger = logging.getLogger("GroqRateLimit")

class GroqRateLimiter:
    """Manages rate limiting compliance and cooldown states for Groq API endpoints."""
    ...
    def wait_if_needed(self) -> None:
        ...
        while True:
            ...
            if sleep_duration > 0:
                logger.info(f"Groq client pacing engaged. Delaying request by {sleep_duration:.2f}s.")
    ...
    def enforce_cooldown(self, duration_seconds: float) -> None:
        ...
        with self._lock:
            ...
            logger.warning(f"Groq rate limiter activated an explicit cooldown for {duration_seconds}s.")